...
/**
 * Tenta encontrar a configuração de breadcrumb que corresponde ao pathname fornecido.
 *
 * @param pathname Caminho para a rota
 * @return Configuração do breadcrumb e correspondência de regex, ou null se não encontrar
 */
